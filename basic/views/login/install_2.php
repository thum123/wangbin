...
<div class="container clearfix">
    ...
    <div class="main-wrap">
        ...
        <form action="index.php?r=login/anzhuang3" method="post">
        <div class="result-wrap">
            <div class="result-title">
                <h1>填写用户名密码</h1>
            </div>
            <div class="result-content">
                ...
                <ul class="sys-info-list">
                    ...
                    <li>
                        <label class="res-lab">密码</label><span class="res-info"><input type="text" name='pass'></span>
                    </li>
                    <li>
                        <label class="res-lab">确认密码</label><span class="res-info"><input type="password" name="pass2"></span>
                    </li>
                </ul>
            </div>
        </div>
