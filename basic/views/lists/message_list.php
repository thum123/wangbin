...
<div class="topbar-wrap white">
    <div class="topbar-inner clearfix">
        <div class="topbar-logo-wrap clearfix">
            <h1 class="topbar-logo none"><a href="index.html" class="navbar-brand">回复消息列表</a></h1>
        ...
        <div class="result-wrap">
            ...
            <?php foreach($data as $k=>$v){?>
                        <tr>
                            ...
                            <td>
                                <?php echo $v['backwords']?>
                            </td>
                            <td>
                                <a href="index.php?r=lists/message&we_id=<?php echo $v['we_id']?>">修改</a>
                                <a href="">删除</a>
                            </td>
